AnnieRoot.p2_3= AnnieRoot.p2_3||{};
AnnieRoot.p2_3.P2_3= function(){
	var s=this;
	...
	var videoPlay_1=function (str){
		...
		var rect={x:954, y:287, w:862, h:482,}//视频位置宽高
	...
	function Check_video(){
		if([1,3].includes(s.currentFrame) && s.mc_Q.visible==false){
			videoPlay_1('p2_3');//默认播放视频
			//补丁，改变位置大小
			if(s.currentFrame==3){
				var rect={x:954, y:358, w:862, h:482,}//视频位置宽高
				floatDisplay.scaleX = rect.w/videoPlayer.width;//旧版尺寸
				floatDisplay.scaleY = rect.h/videoPlayer.height;//旧版尺寸
				floatDisplay.x = rect.x;
				floatDisplay.y = rect.y;
...
annie.A2xExtend(AnnieRoot.p2_3.P2_3,annie.MovieClip);