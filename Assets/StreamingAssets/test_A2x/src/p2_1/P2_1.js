AnnieRoot.p2_1= AnnieRoot.p2_1||{};
AnnieRoot.p2_1.P2_1= function(){
	var s=this;
	annie.MovieClip.call(s);
	/*_a2x_need_start*/s.bt_1=null;s.bt_2=null;s.bt_3=null;s.bt_4=null;s.bt_back=null;s.bt_end=null;s.mc_Q=null;/*_a2x_need_end*/
	annie.initRes(s,"p2_1","P2_1");
	var bt_list=[
		s.bt_1,
		s.bt_2,
		s.bt_3,
	...
	function Check_video(){
		if([1].includes(s.currentFrame) && s.mc_Q.visible==false){
			videoPlay_1('p2_1');//默认播放视频
		}else{
			videStop_1();//关闭视频
		}
	}
...
annie.A2xExtend(AnnieRoot.p2_1.P2_1,annie.MovieClip);